...
<div class="card-body">
    ...
    @endif
    <center><h1><b>Shipments</b></h1>
        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalCenter">
            Stored Images</button>
        <a href="{{ url('/shipment/create') }}" class="btn btn-success btn-sm"> Add Shipment </a></center></br>
        <div class = "container" style="width: 800px; border:2px solid #cecece;">
            {{$dataTable->table()}}
            {{$dataTable->scripts()}} 
